...
#define LOCAL_PORT "8877"

int main(void)
{
    int sfd, bytes, ret;
    char src_host[128], src_service[7], buf[1025];
    ...
    {
	memset(buf,0,1024);
	ret = bytes = recvfrom_inet_dgram_socket(sfd,buf,1024,src_host,127,src_service,6,0,LIBSOCKET_NUMERIC);
